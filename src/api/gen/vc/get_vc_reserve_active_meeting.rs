//! doc url: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve/get_active_meeting>
...
impl<'c, IStore: Store, IClient: HttpClient> VcService<'c, IStore, IClient> {
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve/get_active_meeting>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/vc-v1/reserve/get_active_meeting>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2Fserver-docs%2Fvc-v1%2Freserve%2Fget_active_meeting>
    pub async fn get_vc_reserve_active_meeting(
        &self,
        req: GetVcReserveActiveMeetingReq,
    ) -> Result<(GetVcReserveActiveMeetingResp, CommonResponse), Error> {
        self.get_vc_reserve_active_meeting_with_opt(req, Default::default())
            .await
    }

    /// 参见 [get_vc_reserve_active_meeting](#method.get_vc_reserve_active_meeting) 函数
    pub async fn get_vc_reserve_active_meeting_with_opt(
        &self,
        req: GetVcReserveActiveMeetingReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_get_vc_reserve_active_meeting(&req) {
                tracing::info!("[lark] Vc#GetVcReserveActiveMeeting **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] Vc#GetVcReserveActiveMeeting call api");
        ...
        let (resp, common_resp): (GetVcReserveActiveMeetingRespInner, _) =
...
pub struct GetVcReserveActiveMeetingReq {
    /// 预约ID（预约的唯一标识）
    ///
...
struct GetVcReserveActiveMeetingRespInner {
    #[serde(flatten)]
    data: Option<GetVcReserveActiveMeetingResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct GetVcReserveActiveMeetingResp {
    /// \-
    #[serde(
        rename = "data",
...
mod test_utils {
    ...
    impl<'c, IStore: Store, IClient: HttpClient> VcServiceMocker<'c, IStore, IClient> {
        pub fn mock_get_vc_reserve_active_meeting<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<
            Mocker,
        ...
        pub(super) fn get_mock_get_vc_reserve_active_meeting(
            &self,
            req: &GetVcReserveActiveMeetingReq,
...
mod test {
    use crate::{
        api::gen::vc::get_vc_reserve_active_meeting::{
            GetVcReserveActiveMeetingReq, GetVcReserveActiveMeetingResp,
            GetVcReserveActiveMeetingRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .vc()
            .mock()
            .mock_get_vc_reserve_active_meeting(|_| {
                Ok((
                    GetVcReserveActiveMeetingResp::default(),
        ...
        let res = lark
            .vc()
            .get_vc_reserve_active_meeting(GetVcReserveActiveMeetingReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<GetVcReserveActiveMeetingRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

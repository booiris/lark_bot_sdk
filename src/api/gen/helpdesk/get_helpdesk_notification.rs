//! doc url: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/notification/get>
...
impl<'c, IStore: Store, IClient: HttpClient> HelpdeskService<'c, IStore, IClient> {
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/notification/get>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/helpdesk-v1/notification/get>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2Fserver-docs%2Fhelpdesk-v1%2Fnotification%2Fget>
    pub async fn get_helpdesk_notification(
        &self,
        req: GetHelpdeskNotificationReq,
    ) -> Result<(GetHelpdeskNotificationResp, CommonResponse), Error> {
        self.get_helpdesk_notification_with_opt(req, Default::default())
            .await
    }

    /// 参见 [get_helpdesk_notification](#method.get_helpdesk_notification) 函数
    pub async fn get_helpdesk_notification_with_opt(
        &self,
        req: GetHelpdeskNotificationReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_get_helpdesk_notification(&req) {
                tracing::info!("[lark] Helpdesk#GetHelpdeskNotification **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] Helpdesk#GetHelpdeskNotification call api");
        ...
        let (resp, common_resp): (GetHelpdeskNotificationRespInner, _) =
...
pub struct GetHelpdeskNotificationReq {
    /// 唯一ID
    ///
    /// **是否必填**: 是
    ///
...
struct GetHelpdeskNotificationRespInner {
    #[serde(flatten)]
    data: Option<GetHelpdeskNotificationResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct GetHelpdeskNotificationResp {
    /// \-
    #[serde(
        rename = "data",
...
pub struct NotificationSubResp {
    ...
    pub create_user: Option<NotificationUserSubResp>,
    /// 非必填，创建时间（毫秒时间戳）
    ///
    /// **示例值**: "1626332244719"
    #[serde(
    ...
    pub update_user: Option<NotificationUserSubResp>,
    /// 非必填，更新时间（毫秒时间戳）
    ///
    /// **示例值**: "1626332244719"
    #[serde(
    ...
    /// **示例值**: "0"
    #[serde(
        rename = "push_scope_type",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub push_scope_type: i64,
    /// 非必填，
    ///
    ...
    #[serde(
        rename = "new_staff_scope_department_list",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub new_staff_scope_department_list: Vec<NotificationDepartmentSubResp>,
    /// 非必填，push推送到成员列表
    ///
    ...
    pub user_list: Vec<NotificationUserSubResp>,
    /// 非必填，push推送到的部门信息列表
    ///
    /// **示例值**: "[{"department_id":"od_7c1a2815c9846b5e518b950de0e62de8"}]"
    #[serde(
        rename = "department_list",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub department_list: Vec<NotificationDepartmentSubResp>,
    /// 非必填，push推送到的会话列表(群)
    ///
    ...
    pub chat_list: Vec<NotificationChatSubResp>,
    /// 非必填，预留扩展字段
    ///
    /// **示例值**: "{}"
    #[serde(
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct NotificationUserSubResp {
    /// 非必填，用户id
    ///
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct NotificationDepartmentSubResp {
    /// 部门ID
    ///
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct NotificationChatSubResp {
    /// 非必填，会话ID
    ///
...
mod test_utils {
    ...
    impl<'c, IStore: Store, IClient: HttpClient> HelpdeskServiceMocker<'c, IStore, IClient> {
        pub fn mock_get_helpdesk_notification<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<
            Mocker,
        ...
        pub(super) fn get_mock_get_helpdesk_notification(
            &self,
            req: &GetHelpdeskNotificationReq,
...
mod test {
    use crate::{
        api::gen::helpdesk::get_helpdesk_notification::{
            GetHelpdeskNotificationReq, GetHelpdeskNotificationResp,
            GetHelpdeskNotificationRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .helpdesk()
            .mock()
            .mock_get_helpdesk_notification(|_| {
                Ok((
                    GetHelpdeskNotificationResp::default(),
        ...
        let res = lark
            .helpdesk()
            .get_helpdesk_notification(GetHelpdeskNotificationReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<GetHelpdeskNotificationRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

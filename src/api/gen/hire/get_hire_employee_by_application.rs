//! doc url: <https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/employee/get_by_application>
...
impl<'c, IStore: Store, IClient: HttpClient> HireService<'c, IStore, IClient> {
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/employee/get_by_application>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/hire-v1/candidate-management/delivery-process-management/onboard/get_by_application>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2Fserver-docs%2Fhire-v1%2Fcandidate-management%2Fdelivery-process-management%2Fonboard%2Fget_by_application>
    pub async fn get_hire_employee_by_application(
        &self,
        req: GetHireEmployeeByApplicationReq,
    ) -> Result<(GetHireEmployeeByApplicationResp, CommonResponse), Error> {
        self.get_hire_employee_by_application_with_opt(req, Default::default())
            .await
    }

    /// 参见 [get_hire_employee_by_application](#method.get_hire_employee_by_application) 函数
    pub async fn get_hire_employee_by_application_with_opt(
        &self,
        req: GetHireEmployeeByApplicationReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_get_hire_employee_by_application(&req) {
                tracing::info!("[lark] Hire#GetHireEmployeeByApplication **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] Hire#GetHireEmployeeByApplication call api");
        ...
        let (resp, common_resp): (GetHireEmployeeByApplicationRespInner, _) =
...
pub struct GetHireEmployeeByApplicationReq {
...
struct GetHireEmployeeByApplicationRespInner {
    #[serde(flatten)]
    data: Option<GetHireEmployeeByApplicationResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct GetHireEmployeeByApplicationResp {
    /// \-
    #[serde(
        rename = "data",
...
mod test_utils {
    ...
    impl<'c, IStore: Store, IClient: HttpClient> HireServiceMocker<'c, IStore, IClient> {
        pub fn mock_get_hire_employee_by_application<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<
            Mocker,
        ...
        pub(super) fn get_mock_get_hire_employee_by_application(
            &self,
            req: &GetHireEmployeeByApplicationReq,
...
mod test {
    use crate::{
        api::gen::hire::get_hire_employee_by_application::{
            GetHireEmployeeByApplicationReq, GetHireEmployeeByApplicationResp,
            GetHireEmployeeByApplicationRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .hire()
            .mock()
            .mock_get_hire_employee_by_application(|_| {
                Ok((
                    GetHireEmployeeByApplicationResp::default(),
        ...
        let res = lark
            .hire()
            .get_hire_employee_by_application(GetHireEmployeeByApplicationReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<GetHireEmployeeByApplicationRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

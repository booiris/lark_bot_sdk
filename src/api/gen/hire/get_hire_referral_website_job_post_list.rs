//! doc url: <https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/referral_website-job_post/list>
...
impl<'c, IStore: Store, IClient: HttpClient> HireService<'c, IStore, IClient> {
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/referral_website-job_post/list>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/hire-v1/get-candidates/referral/list>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2Fserver-docs%2Fhire-v1%2Fget-candidates%2Freferral%2Flist>
    pub async fn get_hire_referral_website_job_post_list(
        &self,
        req: GetHireReferralWebsiteJobPostListReq,
    ) -> Result<(GetHireReferralWebsiteJobPostListResp, CommonResponse), Error> {
        self.get_hire_referral_website_job_post_list_with_opt(req, Default::default())
            .await
    }

    /// 参见 [get_hire_referral_website_job_post_list](#method.get_hire_referral_website_job_post_list) 函数
    pub async fn get_hire_referral_website_job_post_list_with_opt(
        &self,
        req: GetHireReferralWebsiteJobPostListReq,
        ...
        #[cfg(feature = "test-util")]
        {
            if let Some(f) = self
                .mock()
                .get_mock_get_hire_referral_website_job_post_list(&req)
            {
                tracing::info!("[lark] Hire#GetHireReferralWebsiteJobPostList **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] Hire#GetHireReferralWebsiteJobPostList call api");
        ...
        let (resp, common_resp): (GetHireReferralWebsiteJobPostListRespInner, _) =
...
pub struct GetHireReferralWebsiteJobPostListReq {
    /// 招聘流程类型
    ///
    /// **示例值**: "1"
    ///
...
struct GetHireReferralWebsiteJobPostListRespInner {
    #[serde(flatten)]
    data: Option<GetHireReferralWebsiteJobPostListResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct GetHireReferralWebsiteJobPostListResp {
    /// \-
    #[serde(
        rename = "data",
...
pub struct DataSubResp {
    ...
    pub items: Vec<PortalJobPostSubResp>,
    /// 是否还有更多项
    ///
    /// **示例值**: "true"
    #[serde(
...
mod test_utils {
    ...
    impl<'c, IStore: Store, IClient: HttpClient> HireServiceMocker<'c, IStore, IClient> {
        pub fn mock_get_hire_referral_website_job_post_list<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<
            Mocker,
        ...
        pub(super) fn get_mock_get_hire_referral_website_job_post_list(
            &self,
            req: &GetHireReferralWebsiteJobPostListReq,
...
mod test {
    use crate::{
        api::gen::hire::get_hire_referral_website_job_post_list::{
            GetHireReferralWebsiteJobPostListReq, GetHireReferralWebsiteJobPostListResp,
            GetHireReferralWebsiteJobPostListRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .hire()
            .mock()
            .mock_get_hire_referral_website_job_post_list(|_| {
                Ok((
                    GetHireReferralWebsiteJobPostListResp::default(),
        ...
        let res =
            lark.hire()
                .get_hire_referral_website_job_post_list(
                    GetHireReferralWebsiteJobPostListReq::default(),
                )
                .await;
        assert!(res.is_ok());
        mocker.clear();
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<GetHireReferralWebsiteJobPostListRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

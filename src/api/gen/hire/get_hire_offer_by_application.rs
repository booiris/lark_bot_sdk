//! doc url: <https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/offer>
...
impl<'c, IStore: Store, IClient: HttpClient> HireService<'c, IStore, IClient> {
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/offer>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/hire-v1/candidate-management/delivery-process-management/offer/offer>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2Fserver-docs%2Fhire-v1%2Fcandidate-management%2Fdelivery-process-management%2Foffer%2Foffer>
    pub async fn get_hire_offer_by_application(
        &self,
        req: GetHireOfferByApplicationReq,
    ) -> Result<(GetHireOfferByApplicationResp, CommonResponse), Error> {
        self.get_hire_offer_by_application_with_opt(req, Default::default())
            .await
    }

    /// 参见 [get_hire_offer_by_application](#method.get_hire_offer_by_application) 函数
    pub async fn get_hire_offer_by_application_with_opt(
        &self,
        req: GetHireOfferByApplicationReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_get_hire_offer_by_application(&req) {
                tracing::info!("[lark] Hire#GetHireOfferByApplication **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] Hire#GetHireOfferByApplication call api");
        ...
        let (resp, common_resp): (GetHireOfferByApplicationRespInner, _) =
...
pub struct GetHireOfferByApplicationReq {
...
struct GetHireOfferByApplicationRespInner {
    #[serde(flatten)]
    data: Option<GetHireOfferByApplicationResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct GetHireOfferByApplicationResp {
    /// \-
    #[serde(
        rename = "data",
...
pub struct DataSubResp {
    ...
    pub offer: ApplicationOfferSubResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct ApplicationOfferSubResp {
    /// Offer ID
    ///
...
mod test_utils {
    ...
    impl<'c, IStore: Store, IClient: HttpClient> HireServiceMocker<'c, IStore, IClient> {
        pub fn mock_get_hire_offer_by_application<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<
            Mocker,
        ...
        pub(super) fn get_mock_get_hire_offer_by_application(
            &self,
            req: &GetHireOfferByApplicationReq,
...
mod test {
    use crate::{
        api::gen::hire::get_hire_offer_by_application::{
            GetHireOfferByApplicationReq, GetHireOfferByApplicationResp,
            GetHireOfferByApplicationRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .hire()
            .mock()
            .mock_get_hire_offer_by_application(|_| {
                Ok((
                    GetHireOfferByApplicationResp::default(),
        ...
        let res = lark
            .hire()
            .get_hire_offer_by_application(GetHireOfferByApplicationReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<GetHireOfferByApplicationRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

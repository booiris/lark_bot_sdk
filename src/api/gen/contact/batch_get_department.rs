//! doc url: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/batch>
...
impl<'c, IStore: Store, IClient: HttpClient> ContactService<'c, IStore, IClient> {
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/batch>
    ///
    /// new doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/batch>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2FuAjLw4CM%2FukTMukTMukTM%2Freference%2Fcontact-v3%2Fdepartment%2Fbatch>
    pub async fn batch_get_department(
        &self,
        req: BatchGetDepartmentReq,
    ) -> Result<(BatchGetDepartmentResp, CommonResponse), Error> {
        self.batch_get_department_with_opt(req, Default::default())
            .await
    }

    /// 参见 [batch_get_department](#method.batch_get_department) 函数
    pub async fn batch_get_department_with_opt(
        &self,
        req: BatchGetDepartmentReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_batch_get_department(&req) {
                tracing::info!("[lark] Contact#BatchGetDepartment **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] Contact#BatchGetDepartment call api");
        ...
        let (resp, common_resp): (BatchGetDepartmentRespInner, _) = self.cli.do_req(req).await?;
...
pub struct BatchGetDepartmentReq {
...
struct BatchGetDepartmentRespInner {
    #[serde(flatten)]
    data: Option<BatchGetDepartmentResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct BatchGetDepartmentResp {
    /// \-
    #[serde(
        rename = "data",
...
mod test_utils {
    ...
    pub trait MockFunc:
        Fn(BatchGetDepartmentReq) -> Result<(BatchGetDepartmentResp, CommonResponse), Error>
        + Send
        + Sync
        + 'static
    {
    ...
    impl<
            T: Fn(BatchGetDepartmentReq) -> Result<(BatchGetDepartmentResp, CommonResponse), Error>
                + Send
                + Sync
                + 'static,
        > MockFunc for T
    ...
    impl<'c, IStore: Store, IClient: HttpClient> ContactServiceMocker<'c, IStore, IClient> {
        pub fn mock_batch_get_department<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<Mocker, BatchGetDepartmentReq, BatchGetDepartmentResp, Arc<dyn MockFunc>>
        {
            MockerBuilder::new(self.cli.instance_id, Arc::new(f))
        }

        pub(super) fn get_mock_batch_get_department(
            &self,
            req: &BatchGetDepartmentReq,
        ) -> Option<Arc<dyn MockFunc>> {
            do_mock::<Mocker, BatchGetDepartmentReq, BatchGetDepartmentResp, Arc<dyn MockFunc>>(
...
mod test {
    use crate::{
        api::gen::contact::batch_get_department::{
            BatchGetDepartmentReq, BatchGetDepartmentResp, BatchGetDepartmentRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .contact()
            .mock()
            .mock_batch_get_department(|_| {
                Ok((BatchGetDepartmentResp::default(), CommonResponse::default()))
            })
            .build();
        let res = lark
            .contact()
            .batch_get_department(BatchGetDepartmentReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<BatchGetDepartmentRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

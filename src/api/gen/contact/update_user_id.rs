//! doc url: <https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/update_user_id>
...
impl<'c, IStore: Store, IClient: HttpClient> ContactService<'c, IStore, IClient> {
    ...
    ///
    /// new doc: <https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/update_user_id>
    ///

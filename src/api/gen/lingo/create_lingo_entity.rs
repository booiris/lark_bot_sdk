//! doc url: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/lingo-v1/entity/create>
...
impl<'c, IStore: Store, IClient: HttpClient> LingoService<'c, IStore, IClient> {
    /// **api 版本: 2024-04-24T07:19:45+00:00**
    ///
    /// ## 创建免审词条
    ///
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/lingo-v1/entity/create>
    ///
    /// new doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/lingo-v1/entity/create>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2FuAjLw4CM%2FukTMukTMukTM%2Flingo-v1%2Fentity%2Fcreate>
    pub async fn create_lingo_entity(
        &self,
        req: CreateLingoEntityReq,
    ) -> Result<(CreateLingoEntityResp, CommonResponse), Error> {
        self.create_lingo_entity_with_opt(req, Default::default())
            .await
    }

    /// 参见 [create_lingo_entity](#method.create_lingo_entity) 函数
    pub async fn create_lingo_entity_with_opt(
        &self,
        req: CreateLingoEntityReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_create_lingo_entity(&req) {
                tracing::info!("[lark] Lingo#CreateLingoEntity **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] Lingo#CreateLingoEntity call api");
        ...
        let (resp, common_resp): (CreateLingoEntityRespInner, _) = self.cli.do_req(req).await?;
...
pub struct CreateLingoEntityReq {
...
struct CreateLingoEntityRespInner {
    #[serde(flatten)]
    data: Option<CreateLingoEntityResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct CreateLingoEntityResp {
    /// \-
    #[serde(
        rename = "data",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
...
pub struct EntitySubResp {
    ...
    /// 创建者
    ///
    /// **示例值**: "ou_30b07b***518789914dac63d36"
    #[serde(
        rename = "creator",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
...
mod test_utils {
    ...
    pub trait MockFunc:
        Fn(CreateLingoEntityReq) -> Result<(CreateLingoEntityResp, CommonResponse), Error>
        + Send
        + Sync
        + 'static
    {
    ...
    impl<
            T: Fn(CreateLingoEntityReq) -> Result<(CreateLingoEntityResp, CommonResponse), Error>
                + Send
                + Sync
                + 'static,
        > MockFunc for T
    ...
    impl<'c, IStore: Store, IClient: HttpClient> LingoServiceMocker<'c, IStore, IClient> {
        pub fn mock_create_lingo_entity<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<Mocker, CreateLingoEntityReq, CreateLingoEntityResp, Arc<dyn MockFunc>>
        {
            MockerBuilder::new(self.cli.instance_id, Arc::new(f))
        }

        pub(super) fn get_mock_create_lingo_entity(
            &self,
            req: &CreateLingoEntityReq,
        ) -> Option<Arc<dyn MockFunc>> {
            do_mock::<Mocker, CreateLingoEntityReq, CreateLingoEntityResp, Arc<dyn MockFunc>>(
...
mod test {
    use crate::{
        api::gen::lingo::create_lingo_entity::{
            CreateLingoEntityReq, CreateLingoEntityResp, CreateLingoEntityRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .lingo()
            .mock()
            .mock_create_lingo_entity(|_| {
                Ok((CreateLingoEntityResp::default(), CommonResponse::default()))
            })
            .build();
        let res = lark
            .lingo()
            .create_lingo_entity(CreateLingoEntityReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    fn test_req() {
        ...
        if let Err(e) = serde_json::from_str::<super::CreateLingoEntityReqBody>(REQ) {
            panic!("{}", e);
        }
    }
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<CreateLingoEntityRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

//! doc url: <https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block-children/get>
...
impl<'c, IStore: Store, IClient: HttpClient> DriveService<'c, IStore, IClient> {
    /// **api 版本: 2024-07-31T09:16:57+00:00**
    ///
    /// ## 获取所有子块
    ///
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block-children/get>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/docs/docs/docx-v1/document-block/get-2>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2Fserver-docs%2Fdocs%2Fdocs%2Fdocx-v1%2Fdocument-block%2Fget-2>
    pub async fn get_docx_block_list_of_block(
        &self,
        req: GetDocxBlockListOfBlockReq,
    ) -> Result<(GetDocxBlockListOfBlockResp, CommonResponse), Error> {
        self.get_docx_block_list_of_block_with_opt(req, Default::default())
            .await
    }

    /// 参见 [get_docx_block_list_of_block](#method.get_docx_block_list_of_block) 函数
    pub async fn get_docx_block_list_of_block_with_opt(
        &self,
        req: GetDocxBlockListOfBlockReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_get_docx_block_list_of_block(&req) {
                tracing::info!("[lark] Drive#GetDocxBlockListOfBlock **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] Drive#GetDocxBlockListOfBlock call api");
        ...
        let (resp, common_resp): (GetDocxBlockListOfBlockRespInner, _) =
...
pub struct GetDocxBlockListOfBlockReq {
...
struct GetDocxBlockListOfBlockRespInner {
    #[serde(flatten)]
    data: Option<GetDocxBlockListOfBlockResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct GetDocxBlockListOfBlockResp {
    #[serde(
        rename = "data",
...
mod test_utils {
    ...
    impl<'c, IStore: Store, IClient: HttpClient> DriveServiceMocker<'c, IStore, IClient> {
        pub fn mock_get_docx_block_list_of_block<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<
            Mocker,
        ...
        pub(super) fn get_mock_get_docx_block_list_of_block(
            &self,
            req: &GetDocxBlockListOfBlockReq,
...
mod test {
    use crate::{
        api::gen::drive::get_docx_block_list_of_block::{
            GetDocxBlockListOfBlockReq, GetDocxBlockListOfBlockResp,
            GetDocxBlockListOfBlockRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .drive()
            .mock()
            .mock_get_docx_block_list_of_block(|_| {
                Ok((
                    GetDocxBlockListOfBlockResp::default(),
        ...
        let res = lark
            .drive()
            .get_docx_block_list_of_block(GetDocxBlockListOfBlockReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<GetDocxBlockListOfBlockRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

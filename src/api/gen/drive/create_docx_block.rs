//! doc url: <https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block-children/create>
...
impl<'c, IStore: Store, IClient: HttpClient> DriveService<'c, IStore, IClient> {
    /// **api 版本: 2024-07-31T09:17:01+00:00**
    ///
    /// ## 创建块
    ///
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block-children/create>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/docs/docs/docx-v1/document-block/create>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2Fserver-docs%2Fdocs%2Fdocs%2Fdocx-v1%2Fdocument-block%2Fcreate>
    pub async fn create_docx_block(
        &self,
        req: CreateDocxBlockReq,
    ) -> Result<(CreateDocxBlockResp, CommonResponse), Error> {
        self.create_docx_block_with_opt(req, Default::default())
            .await
    }

    /// 参见 [create_docx_block](#method.create_docx_block) 函数
    pub async fn create_docx_block_with_opt(
        &self,
        req: CreateDocxBlockReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_create_docx_block(&req) {
                tracing::info!("[lark] Drive#CreateDocxBlock **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] Drive#CreateDocxBlock call api");
        ...
        let (resp, common_resp): (CreateDocxBlockRespInner, _) = self.cli.do_req(req).await?;
...
pub struct CreateDocxBlockReq {
    ...
    ///
    /// - **长度范围**: `1` 字符- `50` 字符
    #[api(kind = "body", name = "children")]
    pub children: Vec<Option<BlockSubReq>>,
    /// 当前 block 在 children 中的插入位置，起始值为 0，最大值为原 children 长度
    ///
    /// **示例值**: "0"
    #[api(kind = "body", name = "index")]
    pub index: Option<i64>,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct BlockSubReq {
    /// block 类型
    ///
    /// **是否必填**: 是
    ///
    ...
    pub text: Option<TextSubReq>,
    /// 一级标题 Block
    #[serde(
        rename = "heading1",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub heading1: Option<TextSubReq>,
    /// 二级标题 Block
    #[serde(
        rename = "heading2",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub heading2: Option<TextSubReq>,
    /// 三级标题 Block
    #[serde(
        rename = "heading3",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub heading3: Option<TextSubReq>,
    /// 四级标题 Block
    #[serde(
        rename = "heading4",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub heading4: Option<TextSubReq>,
    /// 五级标题 Block
    #[serde(
        rename = "heading5",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub heading5: Option<TextSubReq>,
    /// 六级标题 Block
    #[serde(
        rename = "heading6",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub heading6: Option<TextSubReq>,
    /// 七级标题 Block
    #[serde(
        rename = "heading7",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub heading7: Option<TextSubReq>,
    /// 八级标题 Block
    #[serde(
        rename = "heading8",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub heading8: Option<TextSubReq>,
    /// 九级标题 Block
    #[serde(
        rename = "heading9",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub heading9: Option<TextSubReq>,
    /// 无序列表 Block
    #[serde(
        rename = "bullet",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub bullet: Option<TextSubReq>,
    /// 有序列表 Block
    #[serde(
        rename = "ordered",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub ordered: Option<TextSubReq>,
    /// 代码块 Block
    #[serde(
        rename = "code",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub code: Option<TextSubReq>,
    /// 引用 Block
    #[serde(
        rename = "quote",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub quote: Option<TextSubReq>,
    /// 公式 Block
    #[serde(
        rename = "equation",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub equation: Option<TextSubReq>,
    /// 待办事项 Block
    #[serde(
        rename = "todo",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub todo: Option<TextSubReq>,
    /// 多维表格 Block
    #[serde(
        rename = "bitable",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub bitable: Option<BitableSubReq>,
    /// 高亮块 Block
    #[serde(
        rename = "callout",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub callout: Option<CalloutSubReq>,
    /// 群聊卡片 Block
    #[serde(
        rename = "chat_card",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub chat_card: Option<ChatCardSubReq>,
    /// 分割线 Block
    #[serde(
        rename = "divider",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    ...
    pub grid: Option<GridSubReq>,
    /// 内嵌 Block
    #[serde(
        rename = "iframe",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub iframe: Option<IframeSubReq>,
    /// 图片 Block
    #[serde(
        rename = "image",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    ...
    pub add_ons: Option<AddOnsSubReq>,
    /// 电子表格 Block
    #[serde(
        rename = "sheet",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub sheet: Option<SheetSubReq>,
    /// 表格 Block
    #[serde(
        rename = "table",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub table: Option<TableSubReq>,
    /// 引用容器 Block
    #[serde(
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct TextSubReq {
    /// 文本样式
    #[serde(
        rename = "style",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub style: Option<TextStyleSubReq>,
    /// 文本元素
    ///
    /// **是否必填**: 是
    #[serde(
...
pub struct IframeSubReq {
    ...
    pub component: IframeComponentSubReq,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct AddOnsSubReq {
    /// 文档小组件 ID
    ///
...
pub struct TableSubReq {
    ...
    pub property: TablePropertySubReq,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct OkrSubReq {
    ...
    pub objectives: Vec<Option<ObjectiveIdWithKrIdSubReq>>,
}
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct IframeComponentSubReq {
    /// iframe 类型
    ///
    /// **示例值**: "1"
    ///
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct TablePropertySubReq {
    /// 行数
    ///
    /// **是否必填**: 是
    ///
    ...
    pub merge_info: Vec<Option<TableMergeInfoSubReq>>,
}
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct ObjectiveIdWithKrIdSubReq {
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct TableMergeInfoSubReq {
    /// 从当前行索引起被合并的连续行数
    ///
    /// **示例值**: "2"
    #[serde(
...
struct CreateDocxBlockRespInner {
    #[serde(flatten)]
    data: Option<CreateDocxBlockResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct CreateDocxBlockResp {
    #[serde(
        rename = "data",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
...
mod test_utils {
    ...
    pub trait MockFunc:
        Fn(CreateDocxBlockReq) -> Result<(CreateDocxBlockResp, CommonResponse), Error>
        + Send
        + Sync
        + 'static
    {
    ...
    impl<
            T: Fn(CreateDocxBlockReq) -> Result<(CreateDocxBlockResp, CommonResponse), Error>
                + Send
                + Sync
                + 'static,
        > MockFunc for T
    ...
    impl<'c, IStore: Store, IClient: HttpClient> DriveServiceMocker<'c, IStore, IClient> {
        pub fn mock_create_docx_block<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<Mocker, CreateDocxBlockReq, CreateDocxBlockResp, Arc<dyn MockFunc>>
        {
            MockerBuilder::new(self.cli.instance_id, Arc::new(f))
        }

        pub(super) fn get_mock_create_docx_block(
            &self,
            req: &CreateDocxBlockReq,
        ) -> Option<Arc<dyn MockFunc>> {
            do_mock::<Mocker, CreateDocxBlockReq, CreateDocxBlockResp, Arc<dyn MockFunc>>(
...
mod test {
    use crate::{
        api::gen::drive::create_docx_block::{
            CreateDocxBlockReq, CreateDocxBlockResp, CreateDocxBlockRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .drive()
            .mock()
            .mock_create_docx_block(|_| {
                Ok((CreateDocxBlockResp::default(), CommonResponse::default()))
            })
            .build();
        let res = lark
            .drive()
            .create_docx_block(CreateDocxBlockReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<CreateDocxBlockRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

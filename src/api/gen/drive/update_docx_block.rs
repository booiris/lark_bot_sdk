//! doc url: <https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/patch>
...
impl<'c, IStore: Store, IClient: HttpClient> DriveService<'c, IStore, IClient> {
    /// **api 版本: 2024-07-31T09:17:04+00:00**
    ///
    /// ## 更新块
    ///
    /// 更新指定的块。
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/patch>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/docs/docs/docx-v1/document-block/patch>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2Fserver-docs%2Fdocs%2Fdocs%2Fdocx-v1%2Fdocument-block%2Fpatch>
    pub async fn update_docx_block(
        &self,
        req: UpdateDocxBlockReq,
    ) -> Result<(UpdateDocxBlockResp, CommonResponse), Error> {
        self.update_docx_block_with_opt(req, Default::default())
            .await
    }

    /// 参见 [update_docx_block](#method.update_docx_block) 函数
    pub async fn update_docx_block_with_opt(
        &self,
        req: UpdateDocxBlockReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_update_docx_block(&req) {
                tracing::info!("[lark] Drive#UpdateDocxBlock **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] Drive#UpdateDocxBlock call api");
        ...
        let (resp, common_resp): (UpdateDocxBlockRespInner, _) = self.cli.do_req(req).await?;
...
pub struct UpdateDocxBlockReq {
    ...
    /// 更新文本元素请求
    #[api(kind = "body", name = "update_text_elements")]
    pub update_text_elements: Option<UpdateTextElementsRequestSubReq>,
    /// 更新文本样式请求
    #[api(kind = "body", name = "update_text_style")]
    pub update_text_style: Option<UpdateTextStyleRequestSubReq>,
    /// 更新表格属性请求
    #[api(kind = "body", name = "update_table_property")]
    pub update_table_property: Option<UpdateTablePropertyRequestSubReq>,
    /// 表格插入新行请求
    #[api(kind = "body", name = "insert_table_row")]
    pub insert_table_row: Option<InsertTableRowRequestSubReq>,
    /// 表格插入新列请求
    #[api(kind = "body", name = "insert_table_column")]
    pub insert_table_column: Option<InsertTableColumnRequestSubReq>,
    /// 表格批量删除行请求
    #[api(kind = "body", name = "delete_table_rows")]
    pub delete_table_rows: Option<DeleteTableRowsRequestSubReq>,
    /// 表格批量删除列请求
    #[api(kind = "body", name = "delete_table_columns")]
    pub delete_table_columns: Option<DeleteTableColumnsRequestSubReq>,
    /// 表格合并单元格请求
    #[api(kind = "body", name = "merge_table_cells")]
    pub merge_table_cells: Option<MergeTableCellsRequestSubReq>,
    /// 表格取消单元格合并状态请求
    #[api(kind = "body", name = "unmerge_table_cells")]
    pub unmerge_table_cells: Option<UnmergeTableCellsRequestSubReq>,
    /// 分栏插入新的分栏列请求
    #[api(kind = "body", name = "insert_grid_column")]
    pub insert_grid_column: Option<InsertGridColumnRequestSubReq>,
    /// 分栏删除列请求
    #[api(kind = "body", name = "delete_grid_column")]
    pub delete_grid_column: Option<DeleteGridColumnRequestSubReq>,
    /// 更新分栏列宽比例请求
    #[api(kind = "body", name = "update_grid_column_width_ratio")]
    pub update_grid_column_width_ratio: Option<UpdateGridColumnWidthRatioRequestSubReq>,
    /// 替换图片请求
    #[api(kind = "body", name = "replace_image")]
    pub replace_image: Option<ReplaceImageRequestSubReq>,
    /// 替换附件请求
    #[api(kind = "body", name = "replace_file")]
    pub replace_file: Option<ReplaceFileRequestSubReq>,
    /// 更新文本元素及样式请求
    #[api(kind = "body", name = "update_text")]
    pub update_text: Option<UpdateTextRequestSubReq>,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct UpdateTextElementsRequestSubReq {
    ...
    pub elements: Vec<Option<TextElementSubReq>>,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct UpdateTextStyleRequestSubReq {
    /// 文本样式
    ///
    /// **是否必填**: 是
    #[serde(
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct UpdateTablePropertyRequestSubReq {
    /// 表格列宽
    ///
    /// **是否必填**: 是
    ///
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct InsertTableRowRequestSubReq {
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct InsertTableColumnRequestSubReq {
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct DeleteTableRowsRequestSubReq {
    /// 行开始索引（区间左闭右开）
    ///
    /// **是否必填**: 是
    ///
    ...
    /// **示例值**: "1"
    #[serde(
        rename = "row_end_index",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub row_end_index: i64,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct DeleteTableColumnsRequestSubReq {
    /// 列开始索引（区间左闭右开）
    ///
    /// **是否必填**: 是
    ///
    /// **示例值**: "0"
    #[serde(
        rename = "column_start_index",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub column_start_index: i64,
    /// 列结束索引（区间左闭右开）
    ///
    /// **是否必填**: 是
    ///
    /// **示例值**: "1"
    #[serde(
        rename = "column_end_index",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub column_end_index: i64,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct MergeTableCellsRequestSubReq {
    /// 行起始索引（区间左闭右开）
    ///
    /// **是否必填**: 是
    ///
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct UnmergeTableCellsRequestSubReq {
    /// table 行索引
    ///
    /// **是否必填**: 是
    ///
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct InsertGridColumnRequestSubReq {
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct DeleteGridColumnRequestSubReq {
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct UpdateGridColumnWidthRatioRequestSubReq {
    /// 更新列宽比例时，需要传入所有列宽占比
    ///
    /// **是否必填**: 是
    ///
    ...
    pub width_ratios: Vec<Option<i64>>,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct ReplaceImageRequestSubReq {
    /// 图片 token
    ///
    /// **是否必填**: 是
    ///
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct ReplaceFileRequestSubReq {
    /// 附件 token
    ///
    /// **是否必填**: 是
    ///
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct UpdateTextRequestSubReq {
    /// 更新的文本元素列表，单次更新中 reminder 上限 30 个，mention_doc 上限 50 个，mention_user 上限 100 个
    ///
    /// **是否必填**: 是
    ///
...
pub struct TextElementSubReq {
    ...
    pub mention_user: Option<MentionUserSubReq>,
    /// @文档
    #[serde(
        rename = "mention_doc",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub mention_doc: Option<MentionDocSubReq>,
    /// 日期提醒
    #[serde(
        rename = "reminder",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub reminder: Option<ReminderSubReq>,
    /// 内联附件
    #[serde(
        rename = "file",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub file: Option<InlineFileSubReq>,
    /// 内联 block
    #[serde(
        rename = "inline_block",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub inline_block: Option<InlineBlockSubReq>,
    /// 公式
    #[serde(
        rename = "equation",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub equation: Option<EquationSubReq>,
}
...
pub struct TextRunSubReq {
    ...
    pub text_element_style: Option<TextElementStyleSubReq>,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct MentionUserSubReq {
    /// 用户 OpenID
    ///
    /// **是否必填**: 是
    ///
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct TextElementStyleSubReq {
    /// 加粗
    ///
    /// **示例值**: "true"
    #[serde(
...
struct UpdateDocxBlockRespInner {
    #[serde(flatten)]
    data: Option<UpdateDocxBlockResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct UpdateDocxBlockResp {
    #[serde(
        rename = "data",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
...
pub struct OkrSubResp {
    ...
    pub objectives: Vec<ObjectiveIdWithKrIdSubResp>,
    /// 周期的状态
    ///
    /// **示例值**: ""default""
    ///
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
#[serde(default)]
pub struct ObjectiveIdWithKrIdSubResp {
...
mod test_utils {
    ...
    pub trait MockFunc:
        Fn(UpdateDocxBlockReq) -> Result<(UpdateDocxBlockResp, CommonResponse), Error>
        + Send
        + Sync
        + 'static
    {
    ...
    impl<
            T: Fn(UpdateDocxBlockReq) -> Result<(UpdateDocxBlockResp, CommonResponse), Error>
                + Send
                + Sync
                + 'static,
        > MockFunc for T
    ...
    impl<'c, IStore: Store, IClient: HttpClient> DriveServiceMocker<'c, IStore, IClient> {
        pub fn mock_update_docx_block<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<Mocker, UpdateDocxBlockReq, UpdateDocxBlockResp, Arc<dyn MockFunc>>
        {
            MockerBuilder::new(self.cli.instance_id, Arc::new(f))
        }

        pub(super) fn get_mock_update_docx_block(
            &self,
            req: &UpdateDocxBlockReq,
        ) -> Option<Arc<dyn MockFunc>> {
            do_mock::<Mocker, UpdateDocxBlockReq, UpdateDocxBlockResp, Arc<dyn MockFunc>>(
...
mod test {
    use crate::{
        api::gen::drive::update_docx_block::{
            UpdateDocxBlockReq, UpdateDocxBlockResp, UpdateDocxBlockRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .drive()
            .mock()
            .mock_update_docx_block(|_| {
                Ok((UpdateDocxBlockResp::default(), CommonResponse::default()))
            })
            .build();
        let res = lark
            .drive()
            .update_docx_block(UpdateDocxBlockReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<UpdateDocxBlockRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

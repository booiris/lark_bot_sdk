//! doc url: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_tree/delete>
...
impl<'c, IStore: Store, IClient: HttpClient> ChatService<'c, IStore, IClient> {
    ...
    /// - 操作API后，将返回群内所有菜单。
    ///
    /// doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_tree/delete>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/group/chat-menu_tree/delete>
    ///

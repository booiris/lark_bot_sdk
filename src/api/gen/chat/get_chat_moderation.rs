//! doc url: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-moderation/get>
...
impl<'c, IStore: Store, IClient: HttpClient> ChatService<'c, IStore, IClient> {
    ...
    /// - 机器人 或 授权用户 必须在群里
    ///
    /// doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-moderation/get>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/group/chat/get>
    ///

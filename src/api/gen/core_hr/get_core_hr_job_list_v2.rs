//! doc url: <https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/job/list>
...
impl<'c, IStore: Store, IClient: HttpClient> CoreHrService<'c, IStore, IClient> {
    ...
    ///
    /// new doc: <https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/job/list>
    ///

//! doc url: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/employees-job_data/batch_get>
...
impl<'c, IStore: Store, IClient: HttpClient> CoreHrService<'c, IStore, IClient> {
    /// **api 版本: 2024-07-17T11:11:48+00:00**
    ///
    /// ## 批量查询员工任职信息
    ///
    /// 通过员工雇佣 ID 批量查询任职信息。
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/employees-job_data/batch_get>
    ///
    /// new doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/employees-job_data/batch_get>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2FuAjLw4CM%2FukTMukTMukTM%2Fcorehr-v2%2Femployees-job_data%2Fbatch_get>
    pub async fn batch_get_core_hr_job_data(
        &self,
        req: BatchGetCoreHrJobDataReq,
    ) -> Result<(BatchGetCoreHrJobDataResp, CommonResponse), Error> {
        self.batch_get_core_hr_job_data_with_opt(req, Default::default())
            .await
    }

    /// 参见 [batch_get_core_hr_job_data](#method.batch_get_core_hr_job_data) 函数
    pub async fn batch_get_core_hr_job_data_with_opt(
        &self,
        req: BatchGetCoreHrJobDataReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_batch_get_core_hr_job_data(&req) {
                tracing::info!("[lark] CoreHr#BatchGetCoreHrJobData **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] CoreHr#BatchGetCoreHrJobData call api");
        ...
        let (resp, common_resp): (BatchGetCoreHrJobDataRespInner, _) = self.cli.do_req(req).await?;
...
pub struct BatchGetCoreHrJobDataReq {
    /// 用户 ID 类型
    ///
    /// **示例值**: "open_id"
    ///
    ...
    /// 员工雇佣 ID 列表，可通过[【搜索员工信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search)获取
    ///
...
struct BatchGetCoreHrJobDataRespInner {
    #[serde(flatten)]
    data: Option<BatchGetCoreHrJobDataResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct BatchGetCoreHrJobDataResp {
    /// \-
    #[serde(
        rename = "data",
...
pub struct JobDataSubResp {
    ...
    /// 任职原因，枚举值可通过文档[【飞书人事枚举常量】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)
    ///
    /// 任职原因（assignment_start_reason）枚举定义部分获得
    ///
    /// **示例值**: "onboarding"
    #[serde(
    ...
    /// 试用期结果，枚举值可通过文档[【飞书人事枚举常量】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)
    ///
    /// 试用期结果（probation_outcome）枚举定义部分获得
    ///
    /// **示例值**: "passed"
    #[serde(
...
pub struct BasicJobDataSubResp {
    /// 任职信息 ID，可通过[【查询单个任职信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/job_data/get)
    ///
    /// 获取详细信息
    ///
    /// **示例值**: "1000000"
...
mod test_utils {
    ...
    pub trait MockFunc:
        Fn(BatchGetCoreHrJobDataReq) -> Result<(BatchGetCoreHrJobDataResp, CommonResponse), Error>
        + Send
        + Sync
        + 'static
    {
    ...
    impl<'c, IStore: Store, IClient: HttpClient> CoreHrServiceMocker<'c, IStore, IClient> {
        pub fn mock_batch_get_core_hr_job_data<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<
            Mocker,
        ...
        pub(super) fn get_mock_batch_get_core_hr_job_data(
            &self,
            req: &BatchGetCoreHrJobDataReq,
        ) -> Option<Arc<dyn MockFunc>> {
            do_mock::<Mocker, BatchGetCoreHrJobDataReq, BatchGetCoreHrJobDataResp, Arc<dyn MockFunc>>(
...
mod test {
    use crate::{
        api::gen::core_hr::batch_get_core_hr_job_data::{
            BatchGetCoreHrJobDataReq, BatchGetCoreHrJobDataResp, BatchGetCoreHrJobDataRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .core_hr()
            .mock()
            .mock_batch_get_core_hr_job_data(|_| {
                Ok((
                    BatchGetCoreHrJobDataResp::default(),
        ...
        let res = lark
            .core_hr()
            .batch_get_core_hr_job_data(BatchGetCoreHrJobDataReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    fn test_req() {
        ...
        if let Err(e) = serde_json::from_str::<super::BatchGetCoreHrJobDataReqBody>(REQ) {
            panic!("{}", e);
        }
    }
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<BatchGetCoreHrJobDataRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

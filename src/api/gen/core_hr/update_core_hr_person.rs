//! doc url: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/person/patch>
...
impl<'c, IStore: Store, IClient: HttpClient> CoreHrService<'c, IStore, IClient> {
    /// **api 版本: 2024-07-24T03:06:47+00:00**
    ///
    /// ## 更新个人信息
    ///
    ...
    /// - 非必填字段，不传时即不做变更
    ///
    /// doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/person/patch>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/corehr-v1/employee/person/patch-2>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2Fserver-docs%2Fcorehr-v1%2Femployee%2Fperson%2Fpatch-2>
    pub async fn update_core_hr_person(
        &self,
        req: UpdateCoreHrPersonReq,
    ) -> Result<(UpdateCoreHrPersonResp, CommonResponse), Error> {
        self.update_core_hr_person_with_opt(req, Default::default())
            .await
    }

    /// 参见 [update_core_hr_person](#method.update_core_hr_person) 函数
    pub async fn update_core_hr_person_with_opt(
        &self,
        req: UpdateCoreHrPersonReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_update_core_hr_person(&req) {
                tracing::info!("[lark] CoreHr#UpdateCoreHrPerson **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] CoreHr#UpdateCoreHrPerson call api");
        ...
        let (resp, common_resp): (UpdateCoreHrPersonRespInner, _) = self.cli.do_req(req).await?;
...
pub struct UpdateCoreHrPersonReq {
    /// 个人信息 ID
    ///
    ...
    /// 婚姻状况，可通过[【获取字段详情】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)接口获取，按如下参数查询即可：
    ///
...
pub struct PersonNameSubReq {
    ...
    /// 尊称，可通过 [【获取字段详情】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)获取，按如下参数查询即可：
    ///
    ...
    /// 头衔，可通过 [【获取字段详情】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)获取，按如下参数查询即可：
    ///
    /// - custom_api_name：social
    ///
    /// - object_api_name：person_name
...
pub struct AddressSubReq {
    /// 地址 ID，在[【创建个人信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/person/create)时返回的的地址ID；不可与其他地址使用相同 ID；为空时返回新的ID
    ///
...
pub struct EducationSubReq {
    ...
    /// 国家地区ID，可通过[【查询国家/地区信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region/search)获取
    ///
    /// **示例值**: "1"
    #[serde(
        rename = "country_region_id",
...
pub struct BankAccountSubReq {
    ...
    pub country_region_id: Option<String>,
    /// 银行卡用途，可通过文档[【飞书人事枚举常量】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)
    ///
    /// 银行卡用途（Bank Account Usage）枚举定义获得
    #[serde(
        rename = "bank_account_usage",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    pub bank_account_usage: Vec<Option<EnumSubReq>>,
    /// 银行卡类型，可通过文档[【飞书人事枚举常量】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)
    ///
    /// 银行卡类型（Bank Account Type）枚举定义获得
    #[serde(
...
pub struct ResidentTaxSubReq {
    ...
    /// 居民身份，可通过 [【获取字段详情】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)接口查询，查询参数如下：
    ///
...
pub struct FileSubReq {
    /// 文件ID，可通过[【上传文件】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/person/upload)获取
    ///
...
struct UpdateCoreHrPersonRespInner {
    #[serde(flatten)]
    data: Option<UpdateCoreHrPersonResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct UpdateCoreHrPersonResp {
    /// \-
    #[serde(
        rename = "data",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
...
pub struct PersonInfoSubResp {
    ...
    /// 婚姻状况，可通过[【获取字段详情】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)获取，按如下参数查询即可：
    ///
    /// - custom_api_name：marital_status
    ///
    /// - object_api_name：person
    ...
    /// 户口类型，枚举值可通过文档[【飞书人事枚举常量】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)
    ///
    /// 户口类型（hukou_type）枚举定义部分获得
    #[serde(
        rename = "hukou_type",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
    ...
    /// 人才 ID，可通过[【获取人才信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region_subdivision/search)查询详细信息
    ///
    /// **示例值**: "6863326262618752123"
    #[serde(
        rename = "talent_id",
...
pub struct EducationSubResp {
    ...
    /// 国家地区 ID，可通过[【查询国家/地区信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region/search)接口查询获得
    ///
    /// **示例值**: "1"
    #[serde(
        rename = "country_region_id",
...
pub struct BankAccountSubResp {
    ...
    /// 货币 ID，可通过[【查询货币信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-currency/search)接口查询获得
    ///
    /// **示例值**: "12QueryCountryRegionSubdivisionDataReq"
    #[serde(
        rename = "currency_id",
...
pub struct NationalIdSubResp {
    /// 国家证件类型，可通过[【批量查询国家证件类型】](/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/national_id_type/list)接口获取
    ///
    /// **是否必填**: 是
    ///
    /// **示例值**: "6863330041896371725"
...
mod test_utils {
    ...
    pub trait MockFunc:
        Fn(UpdateCoreHrPersonReq) -> Result<(UpdateCoreHrPersonResp, CommonResponse), Error>
        + Send
        + Sync
        + 'static
    {
    ...
    impl<
            T: Fn(UpdateCoreHrPersonReq) -> Result<(UpdateCoreHrPersonResp, CommonResponse), Error>
                + Send
                + Sync
                + 'static,
        > MockFunc for T
    ...
    impl<'c, IStore: Store, IClient: HttpClient> CoreHrServiceMocker<'c, IStore, IClient> {
        pub fn mock_update_core_hr_person<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<Mocker, UpdateCoreHrPersonReq, UpdateCoreHrPersonResp, Arc<dyn MockFunc>>
        {
            MockerBuilder::new(self.cli.instance_id, Arc::new(f))
        }

        pub(super) fn get_mock_update_core_hr_person(
            &self,
            req: &UpdateCoreHrPersonReq,
        ) -> Option<Arc<dyn MockFunc>> {
            do_mock::<Mocker, UpdateCoreHrPersonReq, UpdateCoreHrPersonResp, Arc<dyn MockFunc>>(
...
mod test {
    use crate::{
        api::gen::core_hr::update_core_hr_person::{
            UpdateCoreHrPersonReq, UpdateCoreHrPersonResp, UpdateCoreHrPersonRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .core_hr()
            .mock()
            .mock_update_core_hr_person(|_| {
                Ok((UpdateCoreHrPersonResp::default(), CommonResponse::default()))
            })
            .build();
        let res = lark
            .core_hr()
            .update_core_hr_person(UpdateCoreHrPersonReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    fn test_req() {
        ...
        if let Err(e) = serde_json::from_str::<super::UpdateCoreHrPersonReqBody>(REQ) {
            panic!("{}", e);
        }
    }
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<UpdateCoreHrPersonRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

//! doc url: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/query>
...
impl<'c, IStore: Store, IClient: HttpClient> CoreHrService<'c, IStore, IClient> {
    ...
    ///
    /// 在人事设置[「人员档案配置」页面](https://people.feishu.cn/people/hr-settings/profile)添加的分组，实际上都是自定义对象，可以通过该接口查询分组内的所有字段。使用方式可参考[【操作手册】如何通过 OpenAPI 维护自定义字段](https://feishu.feishu.cn/docx/QlUudBfCtosWMbxx3vxcOFDknn7)
    ///
    /// doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/query>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/corehr-v1/basic-infomation/custom_field/query>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2Fserver-docs%2Fcorehr-v1%2Fbasic-infomation%2Fcustom_field%2Fquery>
    pub async fn get_core_hr_custom_field_list(
        &self,
        req: GetCoreHrCustomFieldListReq,
    ) -> Result<(GetCoreHrCustomFieldListResp, CommonResponse), Error> {
        self.get_core_hr_custom_field_list_with_opt(req, Default::default())
            .await
    }

    /// 参见 [get_core_hr_custom_field_list](#method.get_core_hr_custom_field_list) 函数
    pub async fn get_core_hr_custom_field_list_with_opt(
        &self,
        req: GetCoreHrCustomFieldListReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_get_core_hr_custom_field_list(&req) {
                tracing::info!("[lark] CoreHr#GetCoreHrCustomFieldList **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] CoreHr#GetCoreHrCustomFieldList call api");
        ...
        let (resp, common_resp): (GetCoreHrCustomFieldListRespInner, _) =
...
pub struct GetCoreHrCustomFieldListReq {
    ...
    #[api(
        kind = "query",
        name = "object_api_name_list",
        v_type = "list",
        option = "false"
    )]
    pub object_api_name_list: Vec<String>,
}

#[derive(Debug, Serialize, Deserialize, Clone, lark_bot_sdk_macros::ApiBaseResp)]
struct GetCoreHrCustomFieldListRespInner {
    #[serde(flatten)]
    data: Option<GetCoreHrCustomFieldListResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct GetCoreHrCustomFieldListResp {
    /// \-
    #[serde(
        rename = "data",
...
pub struct DataSubResp {
    ...
    pub items: Vec<CustomFieldSubResp>,
}
...
mod test_utils {
    ...
    impl<'c, IStore: Store, IClient: HttpClient> CoreHrServiceMocker<'c, IStore, IClient> {
        pub fn mock_get_core_hr_custom_field_list<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<
            Mocker,
        ...
        pub(super) fn get_mock_get_core_hr_custom_field_list(
            &self,
            req: &GetCoreHrCustomFieldListReq,
...
mod test {
    use crate::{
        api::gen::core_hr::get_core_hr_custom_field_list::{
            GetCoreHrCustomFieldListReq, GetCoreHrCustomFieldListResp,
            GetCoreHrCustomFieldListRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .core_hr()
            .mock()
            .mock_get_core_hr_custom_field_list(|_| {
                Ok((
                    GetCoreHrCustomFieldListResp::default(),
        ...
        let res = lark
            .core_hr()
            .get_core_hr_custom_field_list(GetCoreHrCustomFieldListReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<GetCoreHrCustomFieldListRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

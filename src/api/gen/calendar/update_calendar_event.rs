//! doc url: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event/patch>
...
impl<'c, IStore: Store, IClient: HttpClient> CalendarService<'c, IStore, IClient> {
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event/patch>
    ///
    /// new doc: <https://open.larkoffice.com/document/server-docs/calendar-v4/calendar-event/patch>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2Fserver-docs%2Fcalendar-v4%2Fcalendar-event%2Fpatch>
    pub async fn update_calendar_event(
        &self,
        req: UpdateCalendarEventReq,
    ) -> Result<(UpdateCalendarEventResp, CommonResponse), Error> {
        self.update_calendar_event_with_opt(req, Default::default())
            .await
    }

    /// 参见 [update_calendar_event](#method.update_calendar_event) 函数
    pub async fn update_calendar_event_with_opt(
        &self,
        req: UpdateCalendarEventReq,
        ...
        {
            if let Some(f) = self.mock().get_mock_update_calendar_event(&req) {
                tracing::info!("[lark] Calendar#UpdateCalendarEvent **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] Calendar#UpdateCalendarEvent call api");
        ...
        let (resp, common_resp): (UpdateCalendarEventRespInner, _) = self.cli.do_req(req).await?;
...
pub struct UpdateCalendarEventReq {
...
struct UpdateCalendarEventRespInner {
    #[serde(flatten)]
    data: Option<UpdateCalendarEventResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct UpdateCalendarEventResp {
    /// \-
    #[serde(
        rename = "data",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
...
mod test_utils {
    ...
    pub trait MockFunc:
        Fn(UpdateCalendarEventReq) -> Result<(UpdateCalendarEventResp, CommonResponse), Error>
        + Send
        + Sync
        + 'static
    {
    ...
    impl<'c, IStore: Store, IClient: HttpClient> CalendarServiceMocker<'c, IStore, IClient> {
        pub fn mock_update_calendar_event<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<Mocker, UpdateCalendarEventReq, UpdateCalendarEventResp, Arc<dyn MockFunc>>
        {
            MockerBuilder::new(self.cli.instance_id, Arc::new(f))
        }

        pub(super) fn get_mock_update_calendar_event(
            &self,
            req: &UpdateCalendarEventReq,
        ) -> Option<Arc<dyn MockFunc>> {
            do_mock::<Mocker, UpdateCalendarEventReq, UpdateCalendarEventResp, Arc<dyn MockFunc>>(
...
mod test {
    use crate::{
        api::gen::calendar::update_calendar_event::{
            UpdateCalendarEventReq, UpdateCalendarEventResp, UpdateCalendarEventRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .calendar()
            .mock()
            .mock_update_calendar_event(|_| {
                Ok((
                    UpdateCalendarEventResp::default(),
        ...
        let res = lark
            .calendar()
            .update_calendar_event(UpdateCalendarEventReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    fn test_req() {
        ...
        if let Err(e) = serde_json::from_str::<super::UpdateCalendarEventReqBody>(REQ) {
            panic!("{}", e);
        }
    }
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<UpdateCalendarEventRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }

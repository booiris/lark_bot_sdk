//! doc url: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/performance-v1/stage_task/find_by_user_list>
...
impl<'c, IStore: Store, IClient: HttpClient> PerformanceService<'c, IStore, IClient> {
    /// **api 版本: 2024-08-02T09:53:32+00:00**
    ///
    /// ## 获取周期任务（指定用户）
    ///
    ...
    ///
    /// doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/performance-v1/stage_task/find_by_user_list>
    ///
    /// new doc: <https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/performance-v1/stage_task/find_by_user_list>
    ///
    /// api url: <https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2FuAjLw4CM%2FukTMukTMukTM%2Fperformance-v1%2Fstage_task%2Ffind_by_user_list>
    pub async fn get_performance_stage_task_by_user(
        &self,
        req: GetPerformanceStageTaskByUserReq,
    ) -> Result<(GetPerformanceStageTaskByUserResp, CommonResponse), Error> {
        self.get_performance_stage_task_by_user_with_opt(req, Default::default())
            .await
    }

    /// 参见 [get_performance_stage_task_by_user](#method.get_performance_stage_task_by_user) 函数
    pub async fn get_performance_stage_task_by_user_with_opt(
        &self,
        req: GetPerformanceStageTaskByUserReq,
        ...
        #[cfg(feature = "test-util")]
        {
            if let Some(f) = self
                .mock()
                .get_mock_get_performance_stage_task_by_user(&req)
            {
                tracing::info!("[lark] Performance#GetPerformanceStageTaskByUser **mocking** api");
                return f(req);
            }
        }

        tracing::info!("[lark] Performance#GetPerformanceStageTaskByUser call api");
        ...
        let (resp, common_resp): (GetPerformanceStageTaskByUserRespInner, _) =
...
pub struct GetPerformanceStageTaskByUserReq {
    /// 用户 ID 类型
    ///
    /// **示例值**: "open_id"
    ///
    ...
    ///
    /// - **最大长度**: `50` 字符
    #[api(kind = "body", name = "user_id_lists")]
    pub user_id_lists: Vec<Option<String>>,
    /// 任务分类，填写则获取指定分类的任务
    ///
    /// <br>
    ///
...
struct GetPerformanceStageTaskByUserRespInner {
    #[serde(flatten)]
    data: Option<GetPerformanceStageTaskByUserResp>,
    #[serde(flatten)]
    base: BaseResp,
}

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct GetPerformanceStageTaskByUserResp {
    /// \-
    #[serde(
        rename = "data",
...
pub struct StageTaskInfoSubResp {
    ...
    /// 处理任务的系统页面链接
    ///
    /// **示例值**: "https://performance.feishu-pre.cn/perf/review/7235911950407352321/7235906557916086300"
    #[serde(
        rename = "jump_url",
        deserialize_with = "crate::utils::serde_helper::null_to_default"
    )]
...
mod test_utils {
    ...
    impl<'c, IStore: Store, IClient: HttpClient> PerformanceServiceMocker<'c, IStore, IClient> {
        pub fn mock_get_performance_stage_task_by_user<F: MockFunc>(
            &self,
            f: F,
        ) -> MockerBuilder<
            Mocker,
        ...
        pub(super) fn get_mock_get_performance_stage_task_by_user(
            &self,
            req: &GetPerformanceStageTaskByUserReq,
...
mod test {
    use crate::{
        api::gen::performance::get_performance_stage_task_by_user::{
            GetPerformanceStageTaskByUserReq, GetPerformanceStageTaskByUserResp,
            GetPerformanceStageTaskByUserRespInner,
        },
    ...
    async fn test_mock() {
        ...
        let mocker = lark
            .performance()
            .mock()
            .mock_get_performance_stage_task_by_user(|_| {
                Ok((
                    GetPerformanceStageTaskByUserResp::default(),
        ...
        let res = lark
            .performance()
            .get_performance_stage_task_by_user(GetPerformanceStageTaskByUserReq::default())
            .await;
        assert!(res.is_ok());
        mocker.clear();
        let res = lark
    ...
    fn test_req() {
        ...
        if let Err(e) = serde_json::from_str::<super::GetPerformanceStageTaskByUserReqBody>(REQ) {
            panic!("{}", e);
        }
    }
    ...
    #[test]
    fn test_resp() {
        let res = serde_json::from_str::<GetPerformanceStageTaskByUserRespInner>(RESP);
        if let Err(e) = res {
            panic!("{}", e);
        }
